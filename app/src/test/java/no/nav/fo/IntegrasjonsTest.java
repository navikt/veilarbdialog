...
public abstract class IntegrasjonsTest {
    ...
    public static void setupIntegrationTestSecurity() {
        ServiceUser serviceUser = FasitUtils.getServiceUser("srvveilarbdialog", "veilarbdialog", "t6");

        // TODO bruker srvveilarbsituasjon, da srvveilarbdialog mangler abac-tilgang!
        serviceUser = FasitUtils.getServiceUser("srvveilarbsituasjon", "veilarbsituasjon", "t6");
        //

        DevelopmentSecurity.setupIntegrationTestSecurity(serviceUser);
    }
